...
//    }
//
//    public static void getCameraAperture(final Handler handler) {
//        if (AModuleCamera.cameraManager().getParameterRangeManager().getError() != null) {
//            logOut(handler, "getCameraAperture  error: " + AModuleCamera.cameraManager().getParameterRangeManager().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterRangeManager().getResult().getCurrentProduct() == CameraProduct.R12){
//                logOut(handler, "getCameraAperture  error: is not support");
//            } else if(AModuleCamera.cameraManager().getParameterRangeManager().getResult().getCurrentProduct() == CameraProduct.XB008){
//                AModuleCamera.cameraManager().getXb008().getCameraAperture(new CallbackWithOneParam<CameraAperture>() {
//                    @Override
//                    public void onFailure(AutelError error) {
//                        logOut(handler, "getCameraAperture  description  " + error.getDescription());
//                    }
//
//                    @Override
//                    public void onSuccess(CameraAperture data) {
//                        logOut(handler, "getCameraAperture " + data);
//                    }
//                });
//            }else{
//                logOut(handler, "getCameraAperture  description  camera type is not clear");
//            }
//        }
//
//    }
//
//    public static void setCameraAperture(final Handler handler) {
//        if (AModuleCamera.cameraManager().getParameterRangeManager().getError() != null) {
//            logOut(handler, "setCameraAperture  error: " + AModuleCamera.cameraManager().getParameterRangeManager().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterRangeManager().getResult().getCurrentProduct() == CameraProduct.R12){
//                logOut(handler, "setCameraAperture  error: is not support");
//            } else if(AModuleCamera.cameraManager().getParameterRangeManager().getResult().getCurrentProduct() == CameraProduct.XB008){
//                AModuleCamera.cameraManager().getXb008().setCameraAperture(CameraAperture.Aperture_2p0, new CallbackWithNoParam() {
//                    @Override
//                    public void onFailure(AutelError error) {
//                        logOut(handler, "setCameraAperture  description  " + error.getDescription());
//                    }
//
//                    @Override
//                    public void onSuccess() {
//                        logOut(handler, "setCameraAperture state onSuccess");
//                    }
//                });
//            }else{
//                logOut(handler, "setCameraAperture  description  camera type is not clear");
//            }
//        }
//    }
//
